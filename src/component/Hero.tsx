...
export const Hero: React.FC = () => {
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="relative bg-[#F2F0F1] pt-6 md:pt-10 lg:pt-16 overflow-hidden">
        <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-8 lg:px-[100px] flex flex-col lg:flex-row items-center lg:items-stretch justify-between">
          ...
          <div className="w-full lg:max-w-[580px] z-10 flex flex-col items-start pt-2 lg:pt-4 pb-10 lg:pb-[80px]">
            <h1 className="font-extrabold text-[36px] sm:text-[48px] lg:text-[64px] leading-[1] text-black tracking-[-0.03em] mb-5 lg:mb-8 text-left uppercase">
              FIND CLOTHES THAT MATCHES YOUR STYLE
            </h1>
            
            <p className="font-sans text-black/60 text-[14px] sm:text-base leading-[20px] lg:leading-[22px] mb-6 lg:mb-8 max-w-[545px] text-left">
              Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.
            </p>
            
            <a 
              href="#shop" 
              className="w-full sm:w-auto inline-flex items-center justify-center bg-black text-white font-medium text-base rounded-[62px] px-[54px] py-[16px] hover:bg-gray-800 transition-all duration-200 mb-8 lg:mb-12 shadow-sm"
            >
              Shop Now
            </a>
          ...
          {/* Right Column: Hero Image & Overlay Stars */}
          <div className="relative w-full lg:w-[600px] flex justify-center lg:justify-end items-end mt-10 lg:mt-0">
            <img 
              ...
              className="w-full max-w-[380px] sm:max-w-[450px] scale-125 sm:scale-[1.15] lg:max-w-none object-contain object-bottom relative z-10 block m-0 p-0" 
            />
            <img 
              src={starIcon} 
              alt="" 
              aria-hidden="true" 
              className="absolute left-[6%] top-[35%] lg:left-[2%] lg:top-[40%] w-[44px] h-[44px] sm:w-[56px] sm:h-[56px] z-20 object-contain select-none pointer-events-none" 
            />
            <img 
              src={starIcon} 
              alt="" 
              aria-hidden="true" 
              className="absolute right-[5%] top-[6%] lg:right-[5%] lg:top-[10%] w-[76px] h-[76px] sm:w-[104px] sm:h-[104px] z-20 object-contain select-none pointer-events-none" 
            />
          </div>
      ...
      {/* Brand Logos Bar */}
      <div id="brands" className="w-full bg-black relative z-20 -mt-4 sm:-mt-10 lg:-mt-10 scroll-mt-32">
